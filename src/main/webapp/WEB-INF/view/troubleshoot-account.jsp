...
<html lang="en">
<head>
  <title>Troubleshoot account | Dhaansu</title>
  ...
  <div class="content-wrapper">
    ...
    <div style="left: 50%;top:50%;position: absolute;transform: translate(-50%,-50%);width: 90%;">
      <div align="center" style="margin-bottom: 15px;">
        ...
        <br>Recover your account @Dhaansu
      </div>
      
      <!-- START LOCK SCREEN ITEM -->
          <form:form action="/troubleshoot-password" method="post" modelAttribute="troubleshoot-password">
          <table align="center"> 
            <tr>
              <td>
          ...
          <tr>
              <td><input type="text" class="form-control" placeholder="Email address/WhatsApp" name="username"></td>
            </tr>
            <tr>
              <td><input type="submit" value="Recover account"  class="form-control"></td>
            </tr>
          </table>
          </form:form>
        <footer>
