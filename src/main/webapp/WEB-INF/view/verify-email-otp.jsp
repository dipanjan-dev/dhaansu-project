  ...
  <div class="content-wrapper">
    ...
    <div style="left: 50%;top:50%;position: absolute;transform: translate(-50%,-50%);width: 90%;">
      <div align="center" style="margin-bottom: 15px;">
        ...
        <br>We have sent an otp to to your email.<br>Check your email inbox and enter the otp to verify below
      </div>
      
      <!-- START LOCK SCREEN ITEM -->
        <form:form action="/verify-email-otp" method="post" modelAttribute="verify-email-otp">
          <table align="center">
            <tr>
              <td>
